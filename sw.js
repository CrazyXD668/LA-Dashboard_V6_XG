...
const BUILD_VERSION = '202609250943';
...
const APP_SHELL = [
  ...
  './js/frame-guard.js',
  './js/filter-engine.js?v=202609250943',
  './js/main.js?v=202609250943',
  './js/vendor/d3.min.js',
  './js/chart-registry.js?v=202609250943',
  './js/help-modal.js?v=202609250943',
  './js/behavior-loader.js?v=202609250943',
  './js/tab-behavior-radar.js?v=202609250943',
  './js/tab-behavior-correlation.js?v=202609250943',
  './js/tab-behavior-time.js?v=202609250943',
  './js/tab-behavior-lsa.js?v=202609250943',
  './js/tab-behavior-cross.js?v=202609250943',
  './js/tab-behavior-warning.js?v=202609250943',
  './js/behavior-init.js?v=202609250943',
  './js/at-risk-report.js?v=202609250943',
  './js/print-panel.js?v=202609250943',
  './js/ui-enhancements.js?v=202609250943',
];
